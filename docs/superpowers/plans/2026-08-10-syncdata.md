...
def home(request: Request, db: Session = Depends(get_db)):
    ...
    cfg = obter_config(db)
    return templates.TemplateResponse("conciliar.html", {
        "request": request, "ativo": "conciliar",
...
def ver(conciliacao_id: int, request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("resultado.html", {
        "request": request, "ativo": "conciliar", "c": conc,
...
def listar(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("historico.html", {
        "request": request, "ativo": "historico", "linhas": linhas,
    })
```
...
def form(request: Request, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("configuracoes.html", {
        "request": request, "ativo": "config", "cfg": cfg,
    })
